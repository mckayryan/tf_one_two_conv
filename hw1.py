...
def computation_variable(input_size, target_size):
    ...
    Weights matrix of size: input_size x target_size
        Since we have a fully connected layer between each input and our target layer
...
def onelayer(X, Y_, layersize=10):
    ...
    # define activation function with input
